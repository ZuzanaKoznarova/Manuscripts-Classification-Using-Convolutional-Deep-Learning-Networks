...
def train_dev_split(input_dir = os.getcwd()+'\\data\\CLaMM_train',
...
if __name__ == '__main__':
    ...
    train_dev_split(input_dir=os.getcwd()+'\\data\\CLaMM_train',
                    test_size = .1,
                    random_state = SEED,
    ...
    prepare_test_data(input_dir=os.getcwd()+'\\data\\CLaMM_test',
                      output_path = output_path,
                      target_classes = target_classes)
